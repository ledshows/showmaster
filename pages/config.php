    ...
    <div class="sm-props">
      ...
      <div class="sm-propsHeader">
        <div class="sm-propsRow sm-propsRowAdd">
          ...
          <button class="buttons btn-outline-light sm-addBtn" id="smAddSeek10" title="Add +10s seek button to canvas"><span class="smPlus">+</span><span class="smBtnText">+10s</span></button>
